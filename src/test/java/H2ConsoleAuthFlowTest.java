...
public class H2ConsoleAuthFlowTest {
    ...
    void ensureUserAndLogin() throws Exception {
        final String username = "HamitM.";
        final String email    = "hamitmizrak@gmail.com";
        final String password = "H123456.";
    ...
    void runMainConsoleMenuOnce2() throws Exception {
        ...
        try (var c = DriverManager.getConnection(FILE_DB_URL, "sa", "");
        ...
        var in  = new ByteArrayInputStream(scriptedInput.getBytes(StandardCharsets.UTF_8));
        var bos = new java.io.ByteArrayOutputStream();
        System.setIn(in);
        System.setOut(new java.io.PrintStream(bos, true, StandardCharsets.UTF_8));
